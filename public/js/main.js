...
"undefined"!==typeof console&&(p=function(){return console.log.apply(console,d(arguments))},q=function(){return console.error.apply(console,d(arguments))});if("undefined"===typeof l||"undefined"===typeof m||"undefined"===typeof x)var x=function(){throw Error("cljs.core/*eval* not bound");};alert("hello from cljs");